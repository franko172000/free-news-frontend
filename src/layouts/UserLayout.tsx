...
const navigation = [
    { name: 'Dashboard', href: DASHBOARD_ROUTE, current: true },
    { name: 'Your Profile', href: PROFILE_ROUTE, current: false },
    { name: 'Preferences', href: PREFERENCE_ROUTE, current: false }
]
